...
import { GetAddressBookDataFilter } from '../types/interceptor-messages.js'
...
async function filterAddressBookDataByCategoryAndSearchString(searchString: string | undefined): Promise<any> {
...
export async function getMetadataForAddressBookData(filter: GetAddressBookDataFilter) {
	const filtered = await filterAddressBookDataByCategoryAndSearchString(filter.searchString)
	return {
...
export async function findEntryWithSymbolOrName(_: string | undefined, name: string | undefined): Promise<AddressBookEntry | undefined> {
